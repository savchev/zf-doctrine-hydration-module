...
class DoctrineObjectTest extends BaseTest
{
    ...
    {
        $objectManager = $objectManager ?: $this->getMockBuilder(DocumentManager::class)
     ...
     * @test
     */
    public function it_should_be_a_doctrine_hydrator(): void
    {
        $this->assertInstanceOf(DoctrineObjectHydrator::class, $this->createHydrator());
    }

    /**
     * @test
     */
    public function it_should_extract_a_document(): void
    {
     ...
     * @test
     */
    public function it_should_hydrate_a_document(): void
    {
        $creationDate = new \DateTime();
        $birthday = new \DateTime('1 january 2014');
        ...
        $this->assertInstanceOf(HydrationReferenceOne::class, $user->getReferenceOne());
        $referenceMany = $user->getReferenceMany();
        $this->assertInstanceOf(HydrationReferenceMany::class, $referenceMany[0]);
        $this->assertInstanceOf(HydrationEmbedOne::class, $user->getEmbedOne());
        $embedMany = $user->getEmbedMany();
        $this->assertInstanceOf(HydrationEmbedMany::class, $embedMany[0]);
